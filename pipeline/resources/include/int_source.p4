...
control process_int_source (
    ...
    apply {
        // Check if adding the headers will make the packet too big, making it drop
        // If the size exceeds MTU while creating the report it's not a problem, because it will only
        // affect the cloned packet
